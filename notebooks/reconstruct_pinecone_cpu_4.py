...
# %% [markdown] papermill={"duration": 0.001888, "end_time": "2026-05-25T20:06:58.307891+00:00", "exception": false, "start_time": "2026-05-25T20:06:58.306003+00:00", "status": "completed"}
...
# %% papermill={"duration": 0.006775, "end_time": "2026-05-25T20:06:58.316248+00:00", "exception": false, "start_time": "2026-05-25T20:06:58.309473+00:00", "status": "completed"} tags=["parameters"]
image_paths = []
...
# %% papermill={"duration": 0.015443, "end_time": "2026-05-25T20:06:58.333052+00:00", "exception": false, "start_time": "2026-05-25T20:06:58.317609+00:00", "status": "completed"} tags=["injected-parameters"]
# Parameters
...
# %% papermill={"duration": 2.360956, "end_time": "2026-05-25T20:07:00.695371+00:00", "exception": false, "start_time": "2026-05-25T20:06:58.334415+00:00", "status": "completed"}
import os
import time
import psutil
import torch
...
# %% papermill={"duration": 0.145693, "end_time": "2026-05-25T20:07:00.844910+00:00", "exception": false, "start_time": "2026-05-25T20:07:00.699217+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.003298, "end_time": "2026-05-25T20:07:00.852177+00:00", "exception": false, "start_time": "2026-05-25T20:07:00.848879+00:00", "status": "completed"}
# ## Load and Preprocess Images
# Input images are preprocessed and formatted as PyTorch tensors.

# %% papermill={"duration": 0.050966, "end_time": "2026-05-25T20:07:00.906663+00:00", "exception": false, "start_time": "2026-05-25T20:07:00.855697+00:00", "status": "completed"}
if not image_paths:
...
# %% [markdown] papermill={"duration": 0.0014, "end_time": "2026-05-25T20:07:00.910043+00:00", "exception": false, "start_time": "2026-05-25T20:07:00.908643+00:00", "status": "completed"}
# ## Initialize VGG-T³ Model
# Loads the pretrained weights from Hugging Face.

# %% papermill={"duration": 8.494198, "end_time": "2026-05-25T20:07:09.405646+00:00", "exception": false, "start_time": "2026-05-25T20:07:00.911448+00:00", "status": "completed"}
print(f"Loading model '{model_path}' on {device}...")
model = VGGT.from_pretrained(model_path)
model = model.to(device).eval()
log_metrics("Model Loaded")

# %% [markdown] papermill={"duration": 0.001466, "end_time": "2026-05-25T20:07:09.409016+00:00", "exception": false, "start_time": "2026-05-25T20:07:09.407550+00:00", "status": "completed"}
# ## Run Model Inference
# Perform 3D reconstruction and measure resource requirements.

# %% papermill={"duration": 0.767646, "end_time": "2026-05-25T20:07:10.178147+00:00", "exception": true, "start_time": "2026-05-25T20:07:09.410501+00:00", "status": "failed"}
