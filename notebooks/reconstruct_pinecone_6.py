...
# %% [markdown] papermill={"duration": 0.002003, "end_time": "2026-05-25T20:05:10.365140+00:00", "exception": false, "start_time": "2026-05-25T20:05:10.363137+00:00", "status": "completed"}
...
# %% papermill={"duration": 0.00707, "end_time": "2026-05-25T20:05:10.373776+00:00", "exception": false, "start_time": "2026-05-25T20:05:10.366706+00:00", "status": "completed"} tags=["parameters"]
image_paths = []
...
# %% papermill={"duration": 0.0201, "end_time": "2026-05-25T20:05:10.395246+00:00", "exception": false, "start_time": "2026-05-25T20:05:10.375146+00:00", "status": "completed"} tags=["injected-parameters"]
# Parameters
...
# %% papermill={"duration": 2.318505, "end_time": "2026-05-25T20:05:12.715168+00:00", "exception": false, "start_time": "2026-05-25T20:05:10.396663+00:00", "status": "completed"}
import os
import time
import psutil
import torch
...
# %% papermill={"duration": 0.140382, "end_time": "2026-05-25T20:05:12.859397+00:00", "exception": false, "start_time": "2026-05-25T20:05:12.719015+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.003369, "end_time": "2026-05-25T20:05:12.866696+00:00", "exception": false, "start_time": "2026-05-25T20:05:12.863327+00:00", "status": "completed"}
# ## Load and Preprocess Images
# Input images are preprocessed and formatted as PyTorch tensors.

# %% papermill={"duration": 0.066296, "end_time": "2026-05-25T20:05:12.936554+00:00", "exception": false, "start_time": "2026-05-25T20:05:12.870258+00:00", "status": "completed"}
if not image_paths:
...
# %% [markdown] papermill={"duration": 0.001392, "end_time": "2026-05-25T20:05:12.939900+00:00", "exception": false, "start_time": "2026-05-25T20:05:12.938508+00:00", "status": "completed"}
# ## Initialize VGG-T³ Model
# Loads the pretrained weights from Hugging Face.

# %% papermill={"duration": 9.244202, "end_time": "2026-05-25T20:05:22.185527+00:00", "exception": false, "start_time": "2026-05-25T20:05:12.941325+00:00", "status": "completed"}
print(f"Loading model '{model_path}' on {device}...")
model = VGGT.from_pretrained(model_path)
model = model.to(device).eval()
log_metrics("Model Loaded")

# %% [markdown] papermill={"duration": 0.001513, "end_time": "2026-05-25T20:05:22.188916+00:00", "exception": false, "start_time": "2026-05-25T20:05:22.187403+00:00", "status": "completed"}
# ## Run Model Inference
# Perform 3D reconstruction and measure resource requirements.

# %% papermill={"duration": 1.08694, "end_time": "2026-05-25T20:05:23.277336+00:00", "exception": false, "start_time": "2026-05-25T20:05:22.190396+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.001543, "end_time": "2026-05-25T20:05:23.280823+00:00", "exception": false, "start_time": "2026-05-25T20:05:23.279280+00:00", "status": "completed"}
# ## Resource Consumption Summary

# %% papermill={"duration": 0.507972, "end_time": "2026-05-25T20:05:23.790338+00:00", "exception": false, "start_time": "2026-05-25T20:05:23.282366+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.001589, "end_time": "2026-05-25T20:05:23.793920+00:00", "exception": false, "start_time": "2026-05-25T20:05:23.792331+00:00", "status": "completed"}
# ## Output Analysis and Visualizations
# Displaying input images, predicted depth maps, and confidence maps.

# %% papermill={"duration": 0.00708, "end_time": "2026-05-25T20:05:23.802570+00:00", "exception": false, "start_time": "2026-05-25T20:05:23.795490+00:00", "status": "completed"}
...
# %% papermill={"duration": 1.679693, "end_time": "2026-05-25T20:05:25.483970+00:00", "exception": false, "start_time": "2026-05-25T20:05:23.804277+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.022959, "end_time": "2026-05-25T20:05:25.531283+00:00", "exception": false, "start_time": "2026-05-25T20:05:25.508324+00:00", "status": "completed"}
# ## Interactive 3D Point Cloud Visualization (Plotly)
# Renders the reconstructed 3D scene directly in the notebook output.

# %% papermill={"duration": 1.272212, "end_time": "2026-05-25T20:05:26.828070+00:00", "exception": false, "start_time": "2026-05-25T20:05:25.555858+00:00", "status": "completed"}
