...
# %% [markdown] papermill={"duration": 0.001895, "end_time": "2026-05-25T20:08:28.891947+00:00", "exception": false, "start_time": "2026-05-25T20:08:28.890052+00:00", "status": "completed"}
...
# %% papermill={"duration": 0.007405, "end_time": "2026-05-25T20:08:28.900915+00:00", "exception": false, "start_time": "2026-05-25T20:08:28.893510+00:00", "status": "completed"} tags=["parameters"]
image_paths = []
...
# %% papermill={"duration": 0.017997, "end_time": "2026-05-25T20:08:28.920304+00:00", "exception": false, "start_time": "2026-05-25T20:08:28.902307+00:00", "status": "completed"} tags=["injected-parameters"]
# Parameters
...
# %% papermill={"duration": 2.344481, "end_time": "2026-05-25T20:08:31.266178+00:00", "exception": false, "start_time": "2026-05-25T20:08:28.921697+00:00", "status": "completed"}
import os
import time
import psutil
import torch
...
# %% papermill={"duration": 0.155695, "end_time": "2026-05-25T20:08:31.425794+00:00", "exception": false, "start_time": "2026-05-25T20:08:31.270099+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.003399, "end_time": "2026-05-25T20:08:31.433234+00:00", "exception": false, "start_time": "2026-05-25T20:08:31.429835+00:00", "status": "completed"}
# ## Load and Preprocess Images
# Input images are preprocessed and formatted as PyTorch tensors.

# %% papermill={"duration": 0.034488, "end_time": "2026-05-25T20:08:31.471415+00:00", "exception": false, "start_time": "2026-05-25T20:08:31.436927+00:00", "status": "completed"}
if not image_paths:
...
# %% [markdown] papermill={"duration": 0.001443, "end_time": "2026-05-25T20:08:31.474668+00:00", "exception": false, "start_time": "2026-05-25T20:08:31.473225+00:00", "status": "completed"}
# ## Initialize VGG-T³ Model
# Loads the pretrained weights from Hugging Face.

# %% papermill={"duration": 9.407708, "end_time": "2026-05-25T20:08:40.883811+00:00", "exception": false, "start_time": "2026-05-25T20:08:31.476103+00:00", "status": "completed"}
print(f"Loading model '{model_path}' on {device}...")
model = VGGT.from_pretrained(model_path)
model = model.to(device).eval()
log_metrics("Model Loaded")

# %% [markdown] papermill={"duration": 0.001476, "end_time": "2026-05-25T20:08:40.887183+00:00", "exception": false, "start_time": "2026-05-25T20:08:40.885707+00:00", "status": "completed"}
# ## Run Model Inference
# Perform 3D reconstruction and measure resource requirements.

# %% papermill={"duration": 0.808692, "end_time": "2026-05-25T20:08:41.697367+00:00", "exception": false, "start_time": "2026-05-25T20:08:40.888675+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.003778, "end_time": "2026-05-25T20:08:41.705505+00:00", "exception": false, "start_time": "2026-05-25T20:08:41.701727+00:00", "status": "completed"}
# ## Resource Consumption Summary

# %% papermill={"duration": 0.510777, "end_time": "2026-05-25T20:08:42.220226+00:00", "exception": false, "start_time": "2026-05-25T20:08:41.709449+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.003919, "end_time": "2026-05-25T20:08:42.228629+00:00", "exception": false, "start_time": "2026-05-25T20:08:42.224710+00:00", "status": "completed"}
# ## Output Analysis and Visualizations
# Displaying input images, predicted depth maps, and confidence maps.

# %% papermill={"duration": 0.008631, "end_time": "2026-05-25T20:08:42.241229+00:00", "exception": false, "start_time": "2026-05-25T20:08:42.232598+00:00", "status": "completed"}
...
# %% papermill={"duration": 0.509047, "end_time": "2026-05-25T20:08:42.754344+00:00", "exception": false, "start_time": "2026-05-25T20:08:42.245297+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.014809, "end_time": "2026-05-25T20:08:42.788731+00:00", "exception": false, "start_time": "2026-05-25T20:08:42.773922+00:00", "status": "completed"}
# ## Interactive 3D Point Cloud Visualization (Plotly)
# Renders the reconstructed 3D scene directly in the notebook output.

# %% papermill={"duration": 1.260736, "end_time": "2026-05-25T20:08:44.056791+00:00", "exception": false, "start_time": "2026-05-25T20:08:42.796055+00:00", "status": "completed"}
