...
# %% [markdown] papermill={"duration": 0.001906, "end_time": "2026-05-25T20:09:08.103077+00:00", "exception": false, "start_time": "2026-05-25T20:09:08.101171+00:00", "status": "completed"}
...
# %% papermill={"duration": 0.007534, "end_time": "2026-05-25T20:09:08.112175+00:00", "exception": false, "start_time": "2026-05-25T20:09:08.104641+00:00", "status": "completed"} tags=["parameters"]
image_paths = []
...
# %% papermill={"duration": 0.01459, "end_time": "2026-05-25T20:09:08.128143+00:00", "exception": false, "start_time": "2026-05-25T20:09:08.113553+00:00", "status": "completed"} tags=["injected-parameters"]
# Parameters
image_paths = ["/home/kaiser/projects/vgg-ttt/data/nerf_real_360/pinecone/images_8/IMG_7238.png", "/home/kaiser/projects/vgg-ttt/data/nerf_real_360/pinecone/images_8/IMG_7239.png", "/home/kaiser/projects/vgg-ttt/data/nerf_real_360/pinecone/images_8/IMG_7240.png", "/home/kaiser/projects/vgg-ttt/data/nerf_real_360/pinecone/images_8/IMG_7241.png", "/home/kaiser/projects/vgg-ttt/data/nerf_real_360/pinecone/images_8/IMG_7242.png", "/home/kaiser/projects/vgg-ttt/data/nerf_real_360/pinecone/images_8/IMG_7243.png"]
model_path = "nvidia/vgg-ttt"
conf_threshold = 1.2
max_points = 50000
device = "cuda"
...
# %% papermill={"duration": 2.337669, "end_time": "2026-05-25T20:09:10.467231+00:00", "exception": false, "start_time": "2026-05-25T20:09:08.129562+00:00", "status": "completed"}
import os
import time
import psutil
import torch
...
# %% papermill={"duration": 0.139548, "end_time": "2026-05-25T20:09:10.610749+00:00", "exception": false, "start_time": "2026-05-25T20:09:10.471201+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.003592, "end_time": "2026-05-25T20:09:10.618563+00:00", "exception": false, "start_time": "2026-05-25T20:09:10.614971+00:00", "status": "completed"}
# ## Load and Preprocess Images
# Input images are preprocessed and formatted as PyTorch tensors.

# %% papermill={"duration": 0.067823, "end_time": "2026-05-25T20:09:10.690048+00:00", "exception": false, "start_time": "2026-05-25T20:09:10.622225+00:00", "status": "completed"}
if not image_paths:
...
# %% [markdown] papermill={"duration": 0.001383, "end_time": "2026-05-25T20:09:10.693204+00:00", "exception": false, "start_time": "2026-05-25T20:09:10.691821+00:00", "status": "completed"}
# ## Initialize VGG-T³ Model
# Loads the pretrained weights from Hugging Face.

# %% papermill={"duration": 9.350461, "end_time": "2026-05-25T20:09:20.045071+00:00", "exception": false, "start_time": "2026-05-25T20:09:10.694610+00:00", "status": "completed"}
print(f"Loading model '{model_path}' on {device}...")
model = VGGT.from_pretrained(model_path)
model = model.to(device).eval()
log_metrics("Model Loaded")

# %% [markdown] papermill={"duration": 0.001466, "end_time": "2026-05-25T20:09:20.048447+00:00", "exception": false, "start_time": "2026-05-25T20:09:20.046981+00:00", "status": "completed"}
# ## Run Model Inference
# Perform 3D reconstruction and measure resource requirements.

# %% papermill={"duration": 1.082626, "end_time": "2026-05-25T20:09:21.132564+00:00", "exception": false, "start_time": "2026-05-25T20:09:20.049938+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.001531, "end_time": "2026-05-25T20:09:21.136039+00:00", "exception": false, "start_time": "2026-05-25T20:09:21.134508+00:00", "status": "completed"}
# ## Resource Consumption Summary

# %% papermill={"duration": 0.508957, "end_time": "2026-05-25T20:09:21.646536+00:00", "exception": false, "start_time": "2026-05-25T20:09:21.137579+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.001589, "end_time": "2026-05-25T20:09:21.650140+00:00", "exception": false, "start_time": "2026-05-25T20:09:21.648551+00:00", "status": "completed"}
# ## Output Analysis and Visualizations
# Displaying input images, predicted depth maps, and confidence maps.

# %% papermill={"duration": 0.007876, "end_time": "2026-05-25T20:09:21.659613+00:00", "exception": false, "start_time": "2026-05-25T20:09:21.651737+00:00", "status": "completed"}
...
# %% papermill={"duration": 1.682168, "end_time": "2026-05-25T20:09:23.343464+00:00", "exception": false, "start_time": "2026-05-25T20:09:21.661296+00:00", "status": "completed"}
...
# %% [markdown] papermill={"duration": 0.025364, "end_time": "2026-05-25T20:09:23.395713+00:00", "exception": false, "start_time": "2026-05-25T20:09:23.370349+00:00", "status": "completed"}
# ## Interactive 3D Point Cloud Visualization (Plotly)
# Renders the reconstructed 3D scene directly in the notebook output.

# %% papermill={"duration": 1.281812, "end_time": "2026-05-25T20:09:24.704992+00:00", "exception": false, "start_time": "2026-05-25T20:09:23.423180+00:00", "status": "completed"}
